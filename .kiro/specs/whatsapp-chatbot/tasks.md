...
- [ ] 1. Set up async database infrastructure and core models
  ...
  - [ ] 1.3 Create Alembic migration for Chat and Message tables
...
- [ ] 2. Implement Pydantic schemas for request/response validation
  ...
  - [ ] 2.2 Create agent state schemas
...
- [ ] 3. Build repository layer for data access
  ...
  - [ ] 3.2 Implement MessageRepository
...
- [ ] 5. Implement LLM provider abstraction layer
  - [ ] 5.1 Create abstract LLMProvider base class
  ...
  - [ ] 5.3 Create GeminiProvider placeholder
  ...
  - [ ] 5.4 Create LLM provider factory and configuration
...
- [ ] 7. Implement agent tools for service integration
  - [ ] 7.1 Create sync-to-async bridge utility
  ...
  - [ ] 7.2 Implement property search tool
  ...
  - [ ] 7.3 Implement court search tool
  ...
  - [ ] 7.4 Implement availability tool
  ...
  - [ ] 7.7 Create tool registry and initialization
...
- [ ] 8. Implement LangGraph nodes for conversation flow
  - [ ] 8.1 Create basic flow nodes
  ...
  - [ ] 8.2 Implement intent detection node
  ...
  - [ ] 8.3 Implement greeting handler node
  ...
  - [ ] 8.4 Implement indoor search handler node
  ...
  - [ ] 8.5 Implement FAQ handler node
...
- [ ] 9. Implement booking subgraph nodes
  - [ ] 9.1 Implement select property node
  ...
  - [ ] 9.2 Implement select service node
  ...
  - [ ] 9.3 Implement select date node
  ...
  - [ ] 9.4 Implement select time node
  ...
  - [ ] 9.5 Implement confirm booking node
  ...
  - [ ] 9.6 Implement create pending booking node
...
- [ ] 10. Implement LangGraph graph structures
  - [ ] 10.1 Create booking subgraph
  ...
  - [ ] 10.2 Create main conversation graph
  ...
  - [ ] 10.3 Create graph runtime and initialization
...
- [ ] 11. Implement AgentService for orchestration
  - [ ] 11.1 Create AgentService
...
- [ ] 12. Checkpoint - Verify agent and graph implementation
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 13. Implement prompt templates
  - [ ] 13.1 Create intent classification prompts
  ...
  - [ ] 13.2 Create conversation prompts
...
- [ ] 14. Implement API endpoints and routers
  - [ ] 14.1 Create chat message endpoint
  ...
  - [ ] 14.2 Create chat history endpoint
  ...
  - [ ] 14.5 Update health check endpoint
...
- [ ] 15. Implement authentication and dependency injection
  - [ ] 15.1 Create authentication dependencies
  ...
  - [ ] 15.2 Create service dependencies
...
- [ ] 16. Implement structured logging and error handling
  - [ ] 16.1 Create logging configuration
    - Create `Backend/apps/chatbot/app/core/logging_config.py`
    - Configure structured JSON logging
    - Set up log levels and formatters
    - _Requirements: 12.1-12.6_
  
  - [ ] 16.2 Add logging to all service methods
...
- [ ] 17. Implement transaction management and retry logic
  - [ ] 17.1 Add transaction wrappers to repositories
    - Ensure all repository methods properly use async transactions
    - Add rollback handling for failed operations
    - _Requirements: 15.1-15.5_
  
  - [ ] 17.2 Implement retry logic for LLM calls
  ...
  - [ ] 17.3 Add graceful degradation for service failures
    - Implement fallback responses when LLM is unavailable
    - Handle main database service unavailability
    - Provide helpful error messages to users
    - _Requirements: 24.1-24.5_

- [ ] 18. Update main application and wire everything together
  - [ ] 18.1 Update main.py with all routers
  ...
  - [ ] 18.2 Create application factory
...
- [ ] 19. Create utility functions and helpers
  - [ ] 19.1 Create response utility
  ...
  - [ ] 19.2 Create date/time utilities
  ...
  - [ ] 19.3 Create message formatting utilities
