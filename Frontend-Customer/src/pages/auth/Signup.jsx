...
const Signup = () => {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      const result = await authService.signup(signupData.email, signupData.password, fullName, 'customer');
      ...
      <div className="ch-visual-panel">
        ...
        <div className="ch-visual-content">
          ...
          <div className="ch-badge">
            ...
            <span className="ch-badge-text">Join Today</span>
          </div>
          ...
          <p className="ch-hero-subtitle">
            Join thousands of players booking their favorite sports venues
          </p>
          ...
          <div className="ch-form-viewport">
            {signupPanel === 'form' ? (
              <div className="ch-form-inner active">
                ...
                <p className="ch-form-subtitle">Join CourtHub and start booking your games</p>
