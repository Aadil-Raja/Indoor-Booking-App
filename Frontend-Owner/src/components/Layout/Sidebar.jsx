  ...
  return (
    <aside className="ch-sidebar">
      ...
      <nav className="ch-sidebar-nav">
        <Link
          to="/dashboard"
          className={`ch-sidebar-link ${isActive('/dashboard') ? 'active' : ''}`}
        >
        ...
        <Link
          to="/properties"
          className={`ch-sidebar-link ${isActive('/properties') ? 'active' : ''}`}
        >
          <span className="ch-sidebar-icon">🏢</span>
        ...
        <Link
          to="/courts"
          className={`ch-sidebar-link ${isActive('/courts') ? 'active' : ''}`}
        >
        ...
        <Link
          to="/bookings"
          className={`ch-sidebar-link ${isActive('/bookings') ? 'active' : ''}`}
        >
          <span className="ch-sidebar-icon">📅</span>
        ...
        <Link
          to="/profile"
          className={`ch-sidebar-link ${isActive('/profile') ? 'active' : ''}`}
        >
          <span className="ch-sidebar-icon">👤</span>
